...
public final class OffersResponse: Mappable, NSCoding {
    ...
    required public init(coder aDecoder: NSCoder) {
        ...
        self.data = aDecoder.decodeObject(forKey: SerializationKeys.data) as? [Offers]
...
public final class Offers: Mappable, NSCoding {
