...
class EarningOpportunitiesVC: SideBaseViewController {
    ...
    //           }
        ...
        func getDataFromServer(){
            ...
            callWebservice1(URL: URL_EO, httpMethod: .get, Params:nil, completion: { ( response : [String: Any]) in
    ...
    extension EarningOpportunitiesVC: UITableViewDataSource {
        ...
        func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            ...
            cell.showData(objDic: (self.objData[indexPath.row] as? [String: Any])!, ind:"\(indexPath.row + 1)")
    ...
    extension EarningOpportunitiesVC: UITableViewDelegate {
