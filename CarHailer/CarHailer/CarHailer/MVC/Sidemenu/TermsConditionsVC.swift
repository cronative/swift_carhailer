...
class TermsConditionsVC: SideBaseViewController {
    ...
    //           }
        ...
        func getDataFromServer(){
            ...
            callWebservice1(URL: URL_TC, httpMethod: .get, Params:nil, completion: { ( response : [String: Any]) in
    ...
    extension TermsConditionsVC: UITableViewDataSource {
    ...
    extension TermsConditionsVC: UITableViewDelegate {
