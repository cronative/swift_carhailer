...
class ViewAdvertisementVC: SideBaseViewController {
    ...
    //           }
        ...
        func getDataFromServer(){
            ...
            callWebservice1(URL: URL_AdvertVideo, httpMethod: .get, Params:nil, completion: { ( response : [String: Any]) in
    ...
    extension ViewAdvertisementVC: UITableViewDataSource {
        ...
        func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            ...
            let cell :AdvertisementCell = tableView.dequeueReusableCell(withIdentifier: "AdvertisementCell") as! AdvertisementCell
    ...
    extension ViewAdvertisementVC: UITableViewDelegate {
